 ...
 *      Set thesisSet = new {@link structure5.SetVector#SetVector()},
 *          gradSet = new {@link structure5.SetVector#SetVector()};
 *              
 *      //build sets up
 *      for(int i = 0; i < thesis.length; i++) thesisSet.{@link structure5.SetVector#add(Object) add(thesis[i])};
 *      for(int i = 0; i < grad.length; i++) gradSet.{@link structure5.SetVector#add(Object) add(grad[i])};
 *      
 *      //calculate the intersection of the two sets
 *      thesisSet.{@link structure5.SetVector#retainAll(Structure) retainAll(gradSet)};
